...
// ============================================================================
// TunnelBridge — Native Module
// Exposes tunnel start/stop/status to React Native JavaScript
// ============================================================================
...
class TunnelBridge: NSObject {
    ...
    // -------------------------------------------------------------------------
    // Start the VPN tunnel (enable shield)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // Stop the VPN tunnel (disable shield)
    // -------------------------------------------------------------------------
    ...
    @objc func getTunnelStatus(_ resolve: @escaping RCTPromiseResolveBlock,
        ...
        NETunnelProviderManager.loadAllFromPreferences { managers, error in
            ...
            let statusString = statusMap[manager.connection.status] ?? "unknown"
