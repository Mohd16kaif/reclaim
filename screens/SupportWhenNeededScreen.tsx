...
type RootStackParamList = {
  SupportWhenNeeded: any;
  InstantUrgeProtection: any;
...
const SupportWhenNeededScreen: React.FC = () => {
  ...
  // Animation values - Exact same as AlwaysOnBlockingScreen
  ...
  useEffect(() => {
    // Fade in sequence - Exact same as AlwaysOnBlockingScreen
  ...
  const handleNextPress = () => {
    (navigation as any).navigate("InstantUrgeProtection", { ...params });
  };
    ...
    <View style={styles.fullScreen}>
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        <View style={styles.content}>
          ...
          {/* 2. Phone Mockup */}
          <Animated.View style={[styles.phoneSection, phoneAnimatedStyle]}>
            <Image
              source={require('../assets/images/support-when-needed.png')}
              style={styles.phoneImage}
              resizeMode="contain"
            />
          </Animated.View>

          {/* 3 & 4. Heading and Body Text */}
          <Animated.View style={[styles.footerSection, bodyAnimatedStyle]}>
            <Text style={styles.heading}>Support When Needed</Text>
            <View style={styles.bodySection}>
              <Text style={styles.bodyText}>
                Calm guidance is available during moments when staying focused feels difficult.
              </Text>
            </View>
