...
const BuiltForConsistencyScreen: React.FC = () => {
  const navigation = useNavigation<ScreenNavigationProp>();
  const route = useRoute<RouteProp<RootStackParamList, "BuiltForConsistency">>();
  ...
  const handleNextPress = () => {
    (navigation as any).navigate("SupportWhenNeeded", { ...params });
  };
      ...
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        <View style={styles.content}>
          ...
          <Animated.View style={[styles.phoneSection, phoneAnimatedStyle]}>
            <Image
              source={require('../assets/images/built-for-consistency.png')}
          ...
          <Animated.View style={[styles.footerSection, bodyAnimatedStyle]}>
            <Text style={styles.heading}>Built For Consistency</Text>
            <View style={styles.bodySection}>
              <Text style={styles.bodyText}>
                Designed to help you maintain control without relying only on willpower.
              </Text>
            </View>
...
export default BuiltForConsistencyScreen;
