...
type RootStackParamList = { BuiltForConsistency: any; SupportWhenNeeded: any; };
type ScreenNavigationProp = StackNavigationProp<RootStackParamList, "BuiltForConsistency">;
...
const BuiltForConsistencyScreen: React.FC = () => {
  ...
  const handleNextPress = () => { (navigation as any).navigate("SupportWhenNeeded", { ...params }); };
      ...
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        <View style={styles.content}>
          ...
          <Animated.View style={[styles.footerSection, { opacity: bodyOpacity }]}>
            ...
            <View style={styles.bodySection}><Text style={styles.bodyText}>Designed to help you maintain control without relying only on willpower.</Text></View>
