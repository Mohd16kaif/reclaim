...
type UrgeResponseNavigationProp = StackNavigationProp<
  RootStackParamList,
  "UrgeResponse"
>;

type UrgeResponseRouteProp = RouteProp<RootStackParamList, "UrgeResponse">;
...
const responseOptions = [
  "Try to distract",
  "Try to fight it but fail",
  "Give in quickly",
  "It depends on my mood",
];

const UrgeResponseScreen: React.FC = () => {
  const navigation = useNavigation<UrgeResponseNavigationProp>();
  const route = useRoute<UrgeResponseRouteProp>();
  const progressAnim = useRef(new Animated.Value(0)).current;
  const [selectedResponse, setSelectedResponse] = useState<string | null>(null);

  const questionNumber = route.params?.questionNumber ?? 18;
  ...
  const handleContinue = () => {
    ...
    // Navigate to UrgeIntensity screen (question 19)
    navigation.navigate("UrgeIntensity", {
      questionNumber: 19,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <Text style={styles.heading}>
            When urges hit, what do you usually do?
          </Text>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            style={[
              ...
              !selectedResponse && styles.continueButtonDisabled,
            ]}
            activeOpacity={0.85}
...
export default UrgeResponseScreen;
