...
const InstantUrgeProtectionScreen: React.FC = () => {
  ...
  const handleNextPress = () => {
    (navigation as any).navigate("LeaveRating", { ...params });
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.phoneSection}>
            <Animated.View style={[styles.phoneContainer, phoneAnimatedStyle]}>
              <Image
                source={require("../assets/images/instant-urge-protection.png")}
          ...
          <Animated.View style={[styles.footerSection, bodyAnimatedStyle]}>
            ...
            <View style={styles.bodySection}>
              <Text style={styles.bodyText}>
                When urges intensify, you can activate temporary protection to lock access and regain control.
              </Text>
            </View>
