...
type StressFrequencyNavigationProp = StackNavigationProp<
  RootStackParamList,
  "StressFrequency"
>;

type StressFrequencyRouteProp = RouteProp<
  RootStackParamList,
  "StressFrequency"
>;
...
const StressFrequencyScreen: React.FC = () => {
  const navigation = useNavigation<StressFrequencyNavigationProp>();
  const route = useRoute<StressFrequencyRouteProp>();
  const progressAnim = useRef(new Animated.Value(0)).current;
  const [selectedFrequency, setSelectedFrequency] = useState<string | null>(
    null
  );

  const questionNumber = route.params?.questionNumber ?? 10;
  ...
  const handleContinue = () => {
    ...
    // Navigate to session duration screen (question 11)
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <Text style={styles.heading}>
            How often do you watch when you{"'"}re stressed?
          </Text>
...
export default StressFrequencyScreen;
