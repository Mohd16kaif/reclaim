...
type RootStackParamList = {
  ReducedContentExposure: any;
  BuiltForConsistency: any;
};

type ScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  "ReducedContentExposure"
>;
...
const ReducedContentExposureScreen: React.FC = () => {
  ...
  const handleNextPress = () => {
    (navigation as any).navigate("BuiltForConsistency", { ...params });
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.phoneSection}>
            <Animated.View style={[styles.phoneContainer, phoneAnimatedStyle]}>
              <Image
                source={require("../assets/images/reduced-content-exposure.png")}
          ...
          <Animated.View style={[styles.footerSection, bodyAnimatedStyle]}>
            ...
            <View style={styles.bodySection}>
              <Text style={styles.bodyText}>
                Filters limit adult and suggestive content inside social and media platforms.
              </Text>
            </View>
